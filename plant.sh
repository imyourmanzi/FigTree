...
# Date: 2020-11-14
#
# Script to initialize the command line interface on a device.  It modifies or
# replaces current configuration files so that the use a centrally synchronized
# set of configurations.  Multiple environments and shells can be initialized
# using this script.
#
...
# - SSH
# - iTerm2 (application behavior prefs)
# - Vim
#
